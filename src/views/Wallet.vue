...
<template>
  ...
  <div class=" py-6 w-full  lg:pl-64 overflow-x-hidden">
    <MainLayout>
    ...
    <div class="flex justify-start md:justify-start gap-[16px] top-[-15px] left-[-10px] relative bottom-[60px] items-center">
      <button
        @click="isDepositModalOpen = true"
        class="bg-[#1E1E1E] w-[100px] text-white py-2 px-2 rounded-[10px] font-medium flex items-center gap-2"
      >
      ...
      <button
        ...
        class="bg-[#1E1E1E] w-[110px] text-white py-2 px-2 rounded-[10px] flex font-medium gap-[4px] items-center"
      >
    ...
    <div class="border-b-[1px] border-[#636262] w-[370px] relative mt-[40px] -left-4 top-[-50px]"></div>
    <h1 class="relative bottom-[40px] text-2xl font-bold">Account</h1>

    <div
      class="bg-[#1E1E1E] text-white py-2 max-sm:w-[330px] lg:w-[810px] px-4 rounded-[20px] h-[80px] font-semibold flex justify-between gap-[30px] mt-8 -top-[60px] relative my-[60px] text-center items-center align-middle"
    ...
    >
     ...
     <div class="bg-[#1E1E1E] px-4 rounded-[20px] lg:w-[810px]  max-sm:w-[330px]   h-[80px] font-semibold flex justify-between gap-[30px] mt-8 -top-[60px] relative my-[60px] items-center" @click="$router.push('/referals')">
       <div class="flex flex-col gap-2">
          <h1 class="relative bottom-0 left-[-15px] top-[-30px] mb-[0px] p-[0px] text-xl font-bold">Task Commission</h1>
<p class="w-full h-[31px] text-[#DADADA] text-[16px] font-semibold relative -top-[20px]  leading-[1.1]">
  Earn $200 for refering 15 <br> friends .
</p>
    <p class="text-purple-500 relative top-[-15px] pl-[-10px]  "@click="$router.push('/referals')">Refer Now</p>
       </div>
       <img src="" alt="referal " />
</div>
    <h1 class="relative bottom-[105px] text-2xl font-bold">Referral Link</h1>
    <div class="relative bottom-[95px] lg:w-[810px]  max-sm:w-[330px]   bg-[#1E1E1E] text-white font-semibold flex rounded-[20px] flex-col gap-[6px] justify-start items-center">
      <div 
