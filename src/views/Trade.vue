<template>
  <MainLayout class="backdrop-blur-md">
    ...
    <div class="px-1 py-4">
      ...
      <h3 class="flex justify-center gap-56 relative left-[-20px] top-[-20px] mb-[20px] items-center text-white text-xl">Balance: <span class="relative left-[10px] text-bold text-xl">$213</span></h3>
